...
public class ECGShowGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRtnBtn = (ImageButton) findViewById(R.id.Return_from_graph_to_main_button);
        ...
        latitude = intent.getDoubleExtra("n", 0);
        longitude = intent.getDoubleExtra("e", 0);
    ...
    public void onSaveBtnClicked(View v) {
        ...
        input.put("n", latitude+"");
        input.put("e", longitude+"");
